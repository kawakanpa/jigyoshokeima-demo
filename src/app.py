...
QUESTIONS = [
    ...
    },
    {
        ...
        "choices": {
            "A": "売り手企業の簿外債務は買い手に引き継がれない",
            "B": "従業員との雇用契約は買収後に個別に締結し直す必要がある",
            "C": "株主である売り手個人には法人税のみが課税される",
            "D": "売り手企業の許認可・既存契約が原則としてそのまま引き継がれる",
    ...
    },
    {
        ...
        "choices": {
            "A": "後継者が前経営者の経営手法を継続することを保証する制度である",
            "B": "金融機関が経営者個人に求める個人保証のことで、事業承継時の障壁になることがある",
